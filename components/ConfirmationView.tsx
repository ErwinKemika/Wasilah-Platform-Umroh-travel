...
export default function ConfirmationView() {
  ...
  if (status === "loading") {
    return <p className="text-stone-400">Memuat data pendaftaran…</p>;
  }

  if (status === "notfound" || !booking) {
    return (
      <div className="rounded-2xl border border-linen-border bg-linen-card p-8 text-center">
        ...
        <Link
          href="/paket"
          className="mt-4 inline-block rounded-xl bg-wasilah-600 px-5 py-2.5 text-sm font-semibold text-white"
        >
          Lihat Paket Lain
        </Link>
      </div>
  ...
  return (
    <div>
      ...
      <div className="mt-6 rounded-2xl border border-linen-border bg-linen-card p-6">
        <div className="flex items-center justify-between border-b border-linen-border pb-4">
          <span className="text-sm text-stone-500">Kode pendaftaran</span>
          <span className="rounded-lg bg-wasilah-100 px-3 py-1 font-mono text-sm font-bold text-wasilah-900">
            {booking.code}
          </span>
        </div>
      ...
      <div className="mt-6 rounded-2xl border border-linen-border bg-white p-6">
        <p className="font-semibold text-stone-800">Langkah selanjutnya</p>
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-3">
        ...
        <Link
          href="/paket"
          className="rounded-xl border border-wasilah-600 px-5 py-2.5 text-sm font-semibold text-wasilah-700"
        >
